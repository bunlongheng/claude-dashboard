...
// Minimal Web Speech API surface - not in TS's default lib.dom.d.ts, and only
// this component needs it, so the shape is declared locally.
                ...
                <div className="rounded-xl p-4 mb-4" style={{
                    ...
                    {fullText ? (
                        <p style={{ fontSize: 14, lineHeight: 1.6, color: "#f8f8f2", margin: 0 }}>
                            {transcript}
                            {interim && <span style={{ color: "rgba(255,255,255,0.52)" }}>{interim}</span>}
                        </p>
                    ) : (
                        <p style={{ fontSize: 13, color: "rgba(255,255,255,0.5)", margin: 0, textAlign: "center", paddingTop: 20 }}>
