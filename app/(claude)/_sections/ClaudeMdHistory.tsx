...
export default function ClaudeMdHistory({ onRestore }: { onRestore?: (content: string) => void }) {
    ...
    const loadVersion = useCallback(async (id: number) => {
        try {
            const r = await fetch(apiBase(`/api/claude/claude-md-history?id=${id}`));
                    ...
                    {versions.map((v, i) => (
                        ...
                        >
                            ...
                            <div style={{ minWidth: 0 }}>
                                <div style={{ fontSize: 10, color: i === 0 ? "rgba(255,255,255,0.6)" : "rgba(255,255,255,0.52)", fontWeight: i === 0 ? 600 : 400 }}>
                            ...
                            <div className="flex items-center gap-2 mb-3">
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: showDiff ? ACCENT : "rgba(255,255,255,0.52)",
                                    ...
                                    {diffResult.map((line, i) => (
                                        <div key={i} style={{
                                            ...
                                            color: line.type === "add" ? "#4ade80"
                                                : line.type === "remove" ? "#f87171" : "rgba(255,255,255,0.5)",
                                        }}>
